...
static task_t* pick_next_task_tjf(runqueue_t* rq)
{
...
static void enqueue_task_tjf(task_t* t,runqueue_t* rq, int preempted)
{
...
static task_t* steal_task_tjf(runqueue_t* rq)
{
