...
/* Task descriptor *///informacion relacionada con el proceso
typedef struct {
...
/*
// decalration struct lottery rq
typedef struct {
	struct list_headlottery_list_head;
...
extern sched_class_t tjf_ex_sched;
...
static const sched_choice_t available_schedulers[NR_AVAILABLE_SCHEDULERS]= {
	...
	{TJF_EX_SCHED,"TJFEX",&tjf_ex_sched},
};
